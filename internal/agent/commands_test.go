...
func TestCommandByName(t *testing.T) {
	...
	for _, command := range [][]string{composeMetadataCommand, proxyRoutesCommand, sshAuthCommand, securityPostureCommand, listActionsCommand, listDeploymentsCommand, systemdUnitsCommand} {
